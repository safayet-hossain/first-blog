...
@section('content')
        ...
        <div class="container-fluid">
                ...
                <div class="col-lg-12 col-sm-12 col-md-12 slider-wrap">
                        ...
                        <div class="slider-item-content">
                            <div class="post-thumb mb-4">
                                <a href="blog-single.html">
                                    <img src="{{ url('/frontend/assets/images/slider/laravel.png') }}" alt=""
                                        class="img-fluid">
                                </a>
                            </div>
                            ...
                            {{-- <div class="slider-post-content">
                                <span
                                    class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Join</span>
                                <h3 class="post-title mt-1"><a href="blog-single.html">Enroll</a>
                                </h3>
                    ...
                    <div class="slider-item">
                        <div class="slider-item-content">
                            ...
                            {{-- <div class="slider-post-content">
                                <span
                                    class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Join</span>
                                <h3 class="post-title mt-1"><a href="blog-single.html">Enroll</a></h3>
                    ...
                    <div class="slider-item">
                        <div class="slider-item-content">
                            <div class="post-thumb mb-4">
                                <a href="blog-single.html">
                                    <img src="{{ url('/frontend/assets/images/slider/nodejs.png') }}" alt=""
                                        class="img-fluid">
                                </a>
                            </div>
                            {{-- <div class="slider-post-content">
                    ...
                    <div class="slider-item">
                        <div class="slider-item-content">
                            <div class="post-thumb mb-4">
                                <a href="blog-single.html">
                                    <img src="{{ url('/frontend/assets/images/slider/csss.jpg') }}" alt=""
                                        class="img-fluid">
                                </a>
                            </div>
            ...
            <div class="slider-item">
                <div class="slider-item-content">
                    <div class="post-thumb mb-4">
                        <a href="blog-single.html">
                            <img src="{{ url('/frontend/assets/images/slider/postman.png') }}" alt=""
                                class="img-fluid">
                        </a>
                    </div>
        </div>
    ...
    <section class="section-padding">
        <div class="container">
            <h1 style="text-align: center" class="mb-3">Latest </h1>
            <div class="row">
